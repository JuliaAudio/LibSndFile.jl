...
reference_wav = joinpath("data", "440left_880right_0.5amp.wav")
reference_wav_float = joinpath("data", "440left_880right_0.5amp_float.wav")
reference_wav_double = joinpath("data","440left_880right_0.5amp_double.wav")
reference_wav_pcm24 = joinpath("data", "440left_880right_0.5amp_pcm24.wav")
reference_ogg = joinpath("data", "440left_880right_0.5amp.ogg")
reference_flac = joinpath("data", "440left_880right_0.5amp.flac")
